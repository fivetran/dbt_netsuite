...
surrogate_key as ( 
    {% set surrogate_key_fields = ['source_relation', 'transaction_line_id', 'transaction_id', 'accounting_period_id', 'account_name'] if transaction_level else ['source_relation', 'accounting_period_id', 'account_name', 'subsidiary_id'] %}

...
dbt run --target "$db" --vars '{netsuite2__enable_incremental_balance_sheet: true, netsuite2__enable_incremental_income_statement: true, netsuite2__transaction_details_use_incremental: true}' --full-refresh
dbt run --target "$db" --vars '{netsuite2__enable_incremental_balance_sheet: true, netsuite2__enable_incremental_income_statement: true, netsuite2__transaction_details_use_incremental: true}'
dbt test --target "$db"
...
dbt test --target "$db"
dbt run --vars '{netsuite2__using_to_subsidiary: true, netsuite2__using_exchange_rate: true, netsuite2__aggregate_balance_sheet: false, netsuite2__using_vendor_subsidiary_relationships: false}' --target "$db" --full-refresh
dbt test --target "$db"
dbt run --vars '{netsuite2__using_customer_subsidiary_relationships: false, netsuite2__aggregate_income_statement: false, netsuite2__using_vendor_subsidiary_relationships: false}' --target "$db" --full-refresh
dbt test --target "$db"
fi

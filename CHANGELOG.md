...
## Bug Fix
- Resolves potential data type mismatches in `netsuite2__balance_sheet`, which could occur if the **Additional Account Columns** (`accounts_pass_through_columns`) variable was configured.

{% macro netsuite_union_connections(connection_dictionary, single_source_name, single_table_name, default_identifier) %}

{{ adapter.dispatch('netsuite_union_connections', 'netsuite') (connection_dictionary, single_source_name, single_table_name, default_identifier) }}

{%- endmacro %}

{% macro default__netsuite_union_connections(connection_dictionary, single_source_name, single_table_name, default_identifier) %}
